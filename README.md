...
- **Note**: This is a workaround for an ARG limitation. Clusters with very large health check arrays (300+ entries) may still have some Succeeded checks truncated, but all Failed/Critical checks are now prioritized
